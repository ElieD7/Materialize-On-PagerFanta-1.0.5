# Materialize-On-PagerFanta-1.0.5
Ajout de Style Materialize pour la pagination.
...
`MaterializeView` is for Materialize;

```php
<?php

use Pagerfanta\View\MaterializeView;

$view = new MaterializeView();
$options = array('proximity' => 3);
$html = $view->render($pagerfanta, $routeGenerator, $options);
```
...
Options (default):
  ...
  * css_active_class (active light-blue darken-4)
